...
class ItemStatusController extends Controller
{
  ...
  public function search(Request $request)
  {
    ...
    try {
      ...
      $data = ItemStatus::where('name', $search)->get();
  ...
  /**
   *  Fungsi atau method ini berguna untuk menampilkan detail item ItemStatus.
   *
   * @param String $id
...
/**
   * Fungsin ini berguna untuk menampilkkan detail item ItemStatus berupa koleksi
   *
   * @param Request $request
   * @return JSON response;
   */
...
/**
  ...
  {
    try {
      $check = ItemStatus::find($id);
      $checkDataInSoftDelete = ItemStatus::onlyTrashed()
        ->where('id', $id)
        ->get();
  ...
  {
    try {
      ItemStatus::onlyTrashed()->restore();
  ...
  {
    try {
      ItemStatus::onlyTrashed()->forceDelete();
