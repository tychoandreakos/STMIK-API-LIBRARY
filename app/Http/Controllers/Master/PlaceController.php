...
class PlaceController extends Controller
{
  ...
  public function search(Request $request)
  {
    ...
    try {
      ...
      $data = Place::where('name', $search)->get();
  ...
  /**
   *  Fungsi atau method ini berguna untuk menampilkan detail item Place.
   *
   * @param String $id
...
/**
  ...
  public function returnDeleteHistoryData(string $id)
  {
    try {
      $check = Place::find($id);
      $checkDataInSoftDelete = Place::onlyTrashed()
        ->where('id', $id)
        ->get();
